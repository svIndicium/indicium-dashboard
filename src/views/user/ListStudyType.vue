<template>
    <div>
        ...
        <div v-else-if="!error">
            <Button route-name="nieuwestudierichting" size="m" class="button" v-if="$auth.hasPermission('ledenadministratie/write:study_type')"><Icon type="plus" class="buttonicon"></Icon>Voeg toe</Button>
