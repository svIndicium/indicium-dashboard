    ...
    <v-row>
        <v-col
            ...
            <v-card>
                ...
                <v-card-text>
                    <v-text-field v-model="registration.memberDetails.phoneNumber" label="Telefoonnummer" disabled></v-text-field>
                    <v-text-field v-model="registration.mailAddress" label="Primaire emailadres" disabled></v-text-field>
