    ...
    instance = new Vue({
        ...
        async created() {
            ...
            this.auth0Client = await createAuth0Client({
                ...
                scope: 'create:user,admin:user,read:user,create:studyType,read:mailchimp_settings,write:mailchimp_settings,read:sendgrid_settings,write:sendgrid_settings,read:settings',
            });
